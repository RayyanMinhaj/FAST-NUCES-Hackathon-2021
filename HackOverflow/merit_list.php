                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="tagline-message page-title text-center">
                            <h1 style="color: #204d74;font-size: 75px"  >Merit List<i>Spring 2020</i></h1>
                            <ul class="breadcrumb">
        ...
        <section class="section gb nopadtop" >
            <div class="container">
                <div class="boxed boxedp4">
                    ...
                    <h1>Merit List <i>Spring 2020</i></h1>
                    ...
                    <table class="table table-hover"  style= border: 1%; border-style: ridge >
                        ...
                        <tr style="font-size: 20px">
                            ...
                            <th scope="col"><i>Batch </i></th>
                            <th scope="col"><i>Department </i></th>
                    ...
                    <br>
                    <br>
                    <h4>NOTE:<i> Deans List may be excluded due to COVID-19 situation in country.</i></h4>
                </div><!-- end container -->
            </div>
